...
## v1.9.6 — commit `15e66ad` — 2026-07-19
- Default operative marker changed to a small text line under the name — the
  tag was squeezing the name field
...
## v1.9.3 — commit `c9ba6b8` — 2026-07-19
